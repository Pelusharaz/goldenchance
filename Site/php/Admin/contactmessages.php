    ...
    <div class="container" style="overflow:scroll; height:900px; max-width:1000px;">
     <table>
        ...
        <tr>
            ...
            <td><a href="mailto:<?php echo "{$row->email}"; ?>?&subject=Subject : Golden Chance Information Desk&body=Dear <?php echo "{$row->name}"; ?>, " target="_blank"><button type="submit" class="logoutbtn">REPLY</button></a></td>
        </tr>
        <?php
         }
        ?>  
     ...
     <div class="container" style="overflow:scroll; height:900px; max-width:1000px;">
     <table>
         <th><strong style="color:orange;">Enquries</strong></th>
         <tr style="border-radius: 20px;">
             <th>Senders Name</td>
             <th>Phone</td>
             <th>Email</td>
             <th>Message</td>
             <th>Type of Message</td>
             <th>T & C</td>
             <th>Date</td>
             <th>Time</td>
             <th>Delete</td>
        ...
        <tr>
            ...
            <td>
                <form action="deleteproducts.php" method="post" style="box-shadow:none;background-color:transparent;">
                    <input type="hidden" name="deleteenquiry_id" value="<?php echo "{$row->id}"; ?>">
                    <button type="submit" class="logoutbtn" name="deleteenquiry_btn">DELETE</button>
                </form>
            </td>
            <td><a href="mailto:<?php echo "{$row->email}"; ?>?&subject=Subject : Golden Chance Information Desk&body=Dear <?php echo "{$row->name}"; ?>, " target="_blank"><button type="submit" class="logoutbtn">REPLY</button></a></td>
        </tr>
