  ...
  <body>
    <header>
      ...
      <div
        ...
        style="background-image: url('../../img/callrequests.jpg'); height: 550px">
    ...
    <div class="container" style="overflow:scroll; height:900px; max-width:1000px;">
     <table>
         <th><strong style="color:orange;">Call Request</strong></th>
        ...
        <tr>
            ...
            <td><a href="tel:<?php echo "{$row->phone}"; ?>" ><button class="logoutbtn">Call Back</button></a></td>
            <td>
                <form action="deleteproducts.php" method="post" style="box-shadow:none;background-color:transparent;">
                    <input type="hidden" name="deleterequest_id" value="<?php echo "{$row->id}"; ?>">
                    <button type="submit" class="logoutbtn" name="deleterequest_btn">DELETE</button>
                </form>
            </td>
        </tr>
        <?php
