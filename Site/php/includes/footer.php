    <div class="about-us" id="whoweare">
      ...
      <div class="contacts">
        <ul class="reach-us">
          ...
          <li class="nav-item me-3 me-lg-0">
            <a class="nav-link links" href="mailto:goldenchancerealestateltd@gmail.com">
              <span class="badge badge-pill bg-danger"></span>
              <span><i class="fa fa-envelope fa fa-flip-horizontal"></i> goldenchancerealestateltd@gmail.com</span>
            </a>
          </li>
          <!-- <li class="nav-item me-3 me-lg-0">
