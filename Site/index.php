  ...
  <main class="mt-5">
        ...
        ?>
          ...
          <div class="blog">
            <div class="blog-img" style="margin:10px;">
              ...
              <?php } else { ?>
                <img src="<?php echo "php/Admin/blogs/" . "{$row->blogimage}"; ?>" class="img-fluid" style="width:200px; height:200px;" />
              <?php } ?>
    ...
    <!-- <div class="news-blogs" id="blogs" style="background-color:rgba(0, 0, 0, 0.2);padding-top:20px;">
          ...
          <div class="row-blog" style="overflow:scroll;">
            <div class="blog">
              <div class="blog-img" style="margin:10px;">
                <h5 style="font-weight: bolder;">Blog Title</h5>
                <img src="img/land 1.jpg" class="img-fluid" alt="">
                <h7 style="font-weight: bolder;">Posted By:</h7>
                <p>Date:</p>
              </div>
              
              <div class="information">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Neque officiis 
                  iste ut vero laudantium distinctio nihil modi ad? Assumenda enim voluptatibus 
                  excepturi odio repudiandae quam esse sit quae ullam perspiciatis.</p>
                  <button type="submit" name="submit" style="color:white;">Read More</button>
              </div>
            </div>
            ...
            <div class="blog">
              <div class="blog-img" style="margin:10px;">
                <h5 style="font-weight: bolder;">Blog Title</h5>
                <img src="img/land 2.jpg" class="img-fluid" alt="">
                <h7 style="font-weight: bolder;">Posted By:</h7>
                <p>Date:</p>
              </div>
            ...
            <div class="blog">
              <div class="blog-img" style="margin:10px;">
                <h5 style="font-weight: bolder;">Blog Title</h5>
                <img src="img/land 3.jpg" class="img-fluid" alt="">
                <h7 style="font-weight: bolder;">Posted By:</h7>
                <p>Date:</p>
              </div>
            ...
            <div class="blog">
              <div class="blog-img" style="margin:10px;">
                <h5 style="font-weight: bolder;">Blog Title</h5>
                <img src="img/land 4.jpg" class="img-fluid" alt="">
                <h7 style="font-weight: bolder;">Posted By:</h7>
                <p>Date:</p>
              </div>
